    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-slate-900">
        <div className="max-w-4xl mx-auto py-8 px-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    value={user?.email || ""}
                    disabled
                    className="w-full px-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-slate-300 cursor-not-allowed"
                  />
          ...
          {/* Success Message */}
          {saveSuccess && (
            <div className="fixed bottom-4 right-4 p-4 bg-green-900/30 border border-green-700 rounded-lg text-green-400 flex items-center gap-2">
